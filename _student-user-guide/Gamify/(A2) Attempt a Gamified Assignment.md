...
permalink: /student-user-guide/gamify/attempt-a-gamified-assignment/
description: ""
...
<p> <img alt="Attempt Gamified Module" style="width: 80%;" src="/images/1Student/G_AttemptGamified4.png"></p>
</li>
<li><p>You will receive a congratulatory message when you have levelled up.</p>
</li>
	<li>When you have unlocked a Game Story/Collectible, a pop-up will appear.</li>
	<li>Click&nbsp;<strong>Close</strong>&nbsp;to continue with your game.</li>
	<li>For Game Stories with multiple paths (i.e. branches), select a path to continue with your game.
	<p> <img alt="Attempt Gamified Module" style="width: 80%;" src="/images/1Student/G_GameBranch.png"></p>
	</li>
