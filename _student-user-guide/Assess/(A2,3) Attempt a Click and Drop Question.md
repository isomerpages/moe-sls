...
<hr>
<ol>
<li>Click the <strong>Show Options</strong> dropdown arrow to view the Options for a Click-and-Drop question. 
	</li><li>To answer the question:</li>
	<ol style="list-style-type: lower-alpha;">
		<li>click an Option followed by clicking the corresponding blank rectangles in the question.</li>
