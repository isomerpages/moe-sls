...
<p>SLS School Administrators are able to view the Names, SLS User ID, Role(s), Form Class, Index Number, Last Login Date, MIMS Status, SLS Account Status, Last Reset Date, Last Reset By, and Email or all teachers and students of the school. Most of this field can be sorted in ascending/descending order. Click the <strong>Up/Down</strong> arrows in the table header to sort the results.</p>
<ol>
