...
<ol>
  ...
  <li>Open the right menu and click <strong>Switch to Student Account</strong>.</li>
	<img style="width: 35%;" src="/images/2Teacher/Cu-TeacherStudent.png">
...
<hr>
<ol><li>In Student Mode, open the right menu and click <strong>Switch to Teacher Account</strong>.</li>
<br>
<img style="width: 35%;" src="/images/2Teacher/Cu-TeacherStudent1.png">
<br> 
<li>You will be prompted to log in with MIMS or with your SLS password.</li>
</ol>

<img style="width: 50%;" src="/images/2Teacher/Cu-TeacherStudent2.png">