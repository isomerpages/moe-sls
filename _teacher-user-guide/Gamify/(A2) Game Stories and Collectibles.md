...
variant: markdown
---
<h1>(A2) Game Stories and Collectibles</h1><hr>
<h2>Add a Game Story</h2>
<hr>
...
<ol style="list-style-type: lower-roman;">
<li>Click <strong>Create</strong> to proceed.
...
<ol>
<li>You will find three types of Collectibles:
<ol style="list-style-type: lower-alpha;">
...
<li>You may view collectibles with or without conditions by clicking the <strong>Condition</strong> dropdown list.</li>
<li>To create a collectible, click <strong>Add Collectible</strong>. You will need to enter the following details:
<ol style="list-style-type: lower-alpha;">
<li><strong>Collectible Type</strong> - The two collectible types are Achievement and Avatar. Choose one that best suits your need.</li>
...
<p><u>Note</u>: This can be useful for preventing multiple Award prompts to appear at the same time.</p></li>
...
<li>After creating a Collectible, you may click <a target="_blank" href="/teacher-user-guide/gamify/add-conditions-to-game-story-or-collectibles/">Add Conditions</a> to determine when the Collectible will appear during the module.</li>
<li>To duplicate, add, reorder, or delete a Collectible, click the <strong>Overflow</strong> (<strong>3-dot</strong> icon) on the Collectible card and select the respective options.
<p><img alt="Game Stories and Collectibles" style="width: 100%;" src="/images/2Teacher/G_EditCollectibleOverflow.png"></p>
</li>
</ol>
<h2>Edit Game Story or Collectible</h2>
<hr>
<ol>
<li>In the Gamification subpage, select between <strong>Game Stories</strong> and <strong>Collectibles</strong> tab.</li>
<li>Click <strong>Edit</strong> under the <strong>Game Story</strong>/<strong>Collectible</strong> card. You will be able to edit the Title, Description, Image, and Game Branches (if any).</li>
