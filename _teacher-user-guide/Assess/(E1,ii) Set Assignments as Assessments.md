...
variant: markdown
---
<h1 id="set-assignments-as-assessments">(E1,ii) Set Assignments as Assessments</h1><hr>
<ol>
...
<li>Students will not be able to view Assessments on their Assignments tab on the homepage or the Assignments list. Instead, they should log in using SLS or MIMS and select Login for E-Assessment, where they will see a list of assessments assigned to them.</li>
</ul>
...
<p>Note: From Dec 2025 Update, teachers can edit all question types, included as part of a Multiple-Part Question (MPQ), even after students have attempted them. Teachers and students can also view the last edited date and time of the question (not applicable for students in assessments).</p>