...
<ol>
  ...
  <li>If you choose to send the Announcement to Selected Students, click <strong>Add Students</strong>. <img style="width: 50%;" src="/images/2Teacher/N-NewAnnouncement.png"></li>
  <li>In the Add Students subpage, select the checkboxes on the left to include students into the Announcement. You can toggle across Class Groups (should you choose more than 1 Class Group) from the dropdown list. <img style="width: 50%;" src="/images/2Teacher/N-SelectClassGroup.png"></li>
  <li>Click <strong>Add</strong> to proceed.</li>
  <li>The names of the selected students will be shown. To remove them from the list, click the <strong>X</strong> beside their names. <img style="width: 50%;" src="/images/2Teacher/N-RemoveStudents.png"></li>
</ol>
