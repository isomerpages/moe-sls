...
---
<h1>V(B1,ii) iew Notifications (New)</h1>
...
<li>enter a Class group and select the <strong>Notifications</strong> tab.<img style="width: 100%;" src="/images/2Teacher/N-ClassGroupNotification.png"></li>
</ul>
</li>
