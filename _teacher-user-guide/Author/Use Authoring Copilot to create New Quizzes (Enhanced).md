...
<ol><li>
In the Module Editor page of the Quiz, click the <b>orange Pencil</b> icon <img alt="pencilo" style="width:1.5rem; display: inline;" src="/images/Icons/ACP.svg"> on the Quiz card to open Authoring Copilot.
