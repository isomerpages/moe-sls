...
<ul>
<li><a href="/teacher-user-guide/author/create-new-modules/" target="_blank">Create New Modules</a></li>
<li><a href="/teacher-user-guide/author/activate-learning-assistant-in-interactive-component/" target="_blank">Activate Learning Assistant in Interactive Component</a></li>	
<li><a href="/teacher-user-guide/author/use-authoring-copilot-to-create-new-sections/" target="_blank">Use Authoring Copilot to create New Sections</a></li>
...
<li><a href="/teacher-user-guide/author/add-display/" target="_blank">(A2,12) Add Display</a></li>
...
<li><a target="_blank" href="/teacher-user-guide/author/insert-drawings/">(A3,7) Insert Drawings</a></li>
...
<p> For more information on the types of Quizzes, visit <a target="_blank" href="/teacher-user-guide/author/add-existing-from-library-and-starred-resources/">Add Activity from Library and Starred Resources</a>.</p>
<p> For more information on how to Release a Quiz, visit <a target="_blank" href="/teacher-user-guide/assess/release-teacher-marked-quizzes/">Release a Teacher-Marked Quiz</a>.</p>
</li>
