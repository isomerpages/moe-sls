...
---
<h1>Use Authoring Copilot to create New Quizzes (New)</h1>
...
<ol><li>
In the Module Editor page of the Quiz, click the orange Pencil icon <img alt="pencilo" style="width:1.5rem; display: inline;" src="/images/Icons/pencilo.svg"> on the Quiz card to open Authoring Copilot.
...
</li><li>Currently in R1, the knowledge base can only take in text input.  
	</li><li>A maximum of 30,000 characters can be input into this field. </li></ul>
...
<p>Alternatively, you can click <b>Back to Generate Quiz</b> to edit the Quiz Details and regenerate the Quiz. Newly generated questions will be appended to the end of the existing set of questions.</p>
