---
title: (A2,15) Insert Media Objects (Enhanced)
...
variant: markdown
---
<h1 id="insert-media-objects">(A2,15) Insert Media Objects (Enhanced)</h1><hr>
<ul>
...
<li>If the file is valid, it will be uploaded and scanned for viruses.
<p><u>Note</u>:</p>
<ul>
...
<li>However, if you encounter any errors, please ensure that you are uploading files from the <strong>Phone Directory/ Files</strong>.
<ul>
...
<h2 id="add-a-media-object-from-library">Add a Media Object from Library</h2>
<hr>
<ol>
...
<li>You may download the Media Object by clicking the <strong>Download</strong> icon <img style="width:1.5rem; display: inline;" src="/images/Icons/Download.svg"> (if present).</li>
<p><img alt="Insert Media Objects" style="width: 100%;" src="/images/2Teacher/AU_AddMedia1.png"></p>
</ol>
<h2 id="add-starred-media-objects-from-starred-resources">Add Starred Media Objects from Starred Resources (New)</h2>
<hr>
<ol>
...
<li>Click <strong>Add File from Starred Resources</strong> to add an existing Media Object.</li>
<p><img alt="Insert Media Objects" style="width: 100%;" src="/images/2Teacher/AU_AddMediaFiles_1a.png"></p>
<li>Search for media files by entering keywords from their titles. You can then refine your search results using the "Resource Type" filter.</li>
<p><img alt="Insert Media Objects" style="width: 100%;" src="/images/2Teacher/AU_AddMediaFiles_1b.png"></p>
<li>Once you have selected the media file, click the space outside the Component to save your edits.</li>
</ol>