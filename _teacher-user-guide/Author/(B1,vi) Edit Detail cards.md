...
<p></p><li>To view a Module/Section/Activity/Component/Quiz Detail subpage, click the respective card in the Module View page.
...
<li>Module Notes - The Notes are visible only to Teachers with whom the Module is shared.</li>
<li>Hide Section and Activity numbers - By default, this is turned off. You can turn it off so students do not see the Section/Activity numbers but you will still see it in the Module Editor page and Monitoring page.</li>
...
<li>Module Tags - Modules can be tagged to learning objectives in the MOE Content Map to improve searches and recommendations in the Community Gallery.</li>
</ul>
</li>
<li>Module Credited to - You can credit teachers who have contributed to the creation of the Module. Their names will be listed when your Module is published in the Community Gallery. This is different from teachers with whom the Module is shared. Teachers can be given viewing or editing rights via Sharing of Module, but may not have contributed to the Module.</li>
<li>Permissions - by default, these three checkbox will be checked.<ul>
<li>Allow teachers to copy/assign/publish this Module; allow students to copy this Module</li>
...
<hr>
<ol>
	<li>To edit the Activity Details subpage, click the&nbsp;<b>Settings</b> ico&nbsp;on the card found on the Activity page. The following optional details can be eMoe<ul>
