...
<hr>
<ol>
<li>When a Lesson is shared with you, you will receive a notification. The <strong>Notification Alert</strong> icon <img style="width:1.5rem; display: inline;" src="/images/Icons/Notification.png"> indicates new notifications.</li>
...
<li><p>You may also <strong>Make a Copy</strong> of the resource to My Lessons tab in <strong> My Drive </strong>.</p>
	<p><u>Note</u>: You can only make a copy of the Lesson if the Owner has checked the Lesson Permission for<b> Allow teachers to copy/assign/publish and students to copy this lesson</b> under Lesson Settings.</p>
</li>
...
<img alt="Access a Shared Lesson" style="width: 80%;" src="/images/2Teacher/C-SharedWithMe1.png">