...
variant: markdown
---
<h1 id="attach-google-files">(C1,iv) Attach Google Files</h1>
...
<ol>
<li>From the Lesson Editor page, select an Activity and hover your mouse over Text/Media. Select <strong>Google File</strong>, followed by <strong>Add File</strong> or <strong>Embed File</strong>.<img alt="Attach Google Files" style="width: 80%;" src="/images/2Teacher/C-GoogleFile.png"></li>
...
<img alt="Attach Google Files" style="width: 80%;" src="/images/2Teacher/C_GoogleFile2.png"></li>
